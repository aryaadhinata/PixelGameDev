class_name State_Stunt extends State

@export var knockback_speed : float = 200.0
@export var decelerate_speed : float = 10.0
@export var invulnereable_duration : float = 1.0
...
func Enter() -> void:
	...
	player.SetDirection()
	player.UpdateAnimation("stunt")
	
	player.make_invulnerable(invulnereable_duration)
